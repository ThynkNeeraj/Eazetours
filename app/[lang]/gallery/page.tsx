...
export default function Gallery() {
  ...
  return (
    <>
      <Head>
        <title>Eaze Tours Gallery | Travel Moments in India</title>
        <meta
          name="description"
          content="Discover India through Eaze Tours’ photo gallery with stunning landscapes, culture, and adventures from our travel experiences."
        />
      </Head>
    <div>
